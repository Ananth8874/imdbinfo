...
def mock_post_factory(filename: str):
    ...
    def mock_post(*args, **kwargs):
        ...
        return SimpleNamespace(status_code=200, content=json_text, json=lambda: json.loads(json_text))
...
def test_search_title(monkeypatch):
    ...
    monkeypatch.setattr(services.niquests, "post", mock_post_factory("sample_search.json"), raising=False)
